...
public class DeobfuscationTest {
    ...
    public static void main(String[] args) {
        final JarHandler handler = new JarHandler(Game.OSRS, new File("/home/sysassist/Desktop/180/gamepack_180.jar"));
...
//        mediator.submit(new RenameUnique());
        ...
        mediator.run();
        handler.dumpTo("/home/sysassist/Desktop/180/generated-resources/gamepack-rename.jar");
    }
